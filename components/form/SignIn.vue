<template>
    <section class="py-16">
        <div class="flex flex-col items-center justify-center px-6 py-20 mx-auto lg:py-0">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <p class="text-sm font-light text-gray-500">
                            Don’t have an account yet? <NuxtLink to="/signup" class="font-medium text-orange-500 hover:underline">Sign
                                up</NuxtLink>
                        </p>
                    </form>
                </div>
