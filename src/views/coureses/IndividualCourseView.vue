    ...
    <AppContainer v-if="vdoToPlay">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full md:w-1/3" v-if="videoData.length > 0">
                <div class="mt-7">
                    <div
                        class="shadow-2xl shadow-gray-50 dark:shadow-none border border-violet-50 dark:border-blue-850 bg-white dark:bg-blue-750 rounded-md relative">
                        <div class="flex justify-center -translate-y-[1px]">
                            <div class="w-3/4">
                                <div class="flex flex-row">
                                    <div
                                        class="h-[1px] bg-gradient-to-r from-transparent via-pink-500 to-violet-600 w-full">
                                    </div>
                        ...
                        <div class="p-6 md:p-10 lg:p-12 whitespace-nowrap">
                            ...
                            <ul class="space-y-4 font-normal text-blue-550 dark:text-blue-300">
                                <li><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                        class="mr-4 inline text-violet-500 dark:text-blue-350" height="20" width="20"
                                ...
                                <li><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512"
                                        class="mr-4 inline text-violet-500 dark:text-blue-350" height="20" width="20"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <li><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24"
                                        aria-hidden="true" class="mr-4 inline text-violet-500 dark:text-blue-350"
...
<style scoped>[aria-label="Pop out"],
