<template>
    <AppContainer>
        <div class="space-y-6">
            <Heading>YouTube Embed code edit</Heading>
            <div class="flex flex-wrap">
                <div class="lg:w-1/2 p-4">
                    <form class="bg-white p-4 rounded-lg space-y-4" @submit="handleSubmit">
                        <div class="">
                            <label for="message" class="block mb-4 text-sm font-medium text-gray-900">Your YouTube Embed
                                iframe</label>
                ...
                <div class="lg:w-1/2 p-4" v-if="builded">
    ...
    <AppContainer>
        <div class="space-y-6">
            <Heading>Drive Embed code edit</Heading>
            <div class="flex flex-wrap">
                <div class="lg:w-1/2 p-4">
                    <form class="bg-white p-4 rounded-lg space-y-4" @submit="handleSubmit">
                        <div class="">
