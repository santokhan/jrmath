<template>
    <div class="w-full md:w-1/3">
        <div class="mt-7 shadow-2xl shadow-gray-50 border border-orange-50 bg-white rounded-md relative">
            <div class="flex justify-center -translate-y-[1px]">
                <div class="w-3/4">
                    <div class="flex flex-row">
                        <div class="h-[1px] bg-gradient-to-r from-transparent via-pink-500 to-orange-600 w-full">
                        </div>
                        <div class="h-[1px] bg-gradient-to-r from-orange-600 to-transparent w-full"></div>
                    </div>
                </div>
            </div>
            <div class="p-6 md:p-10 lg:p-12 whitespace-nowrap">
                <h2 class="font-semibold text-lg uppercase tracking-wide mb-0">Course Overview</h2>
                <div class="h-[5px] bg-gradient-to-r from-pink-500 to-orange-600 w-16 mt-4 mb-10"></div>
                <ul class="space-y-4 font-normal text-blue-550">
                    <li class="font-medium text-gray-700"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                            viewBox="0 0 24 24" class="mr-4 inline text-orange-500" height="20" width="20"
                    ...
                    <li class="font-medium text-gray-700"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                            viewBox="0 0 16 16" class="mr-4 inline text-orange-500" height="20" width="20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM6.79 5.093A.5.5 0 0 0 6 5.5v5a.5.5 0 0 0 .79.407l3.5-2.5a.5.5 0 0 0 0-.814l-3.5-2.5z">
                            </path>
                        </svg>Pre recorded videos</li>
                    <li class="font-medium text-gray-700"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                            viewBox="0 0 512 512" class="mr-4 inline text-orange-500" height="20" width="20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        </svg>Unlimited lessons</li>
                    <li class="font-medium text-gray-700"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                            viewBox="0 0 640 512" class="mr-4 inline text-orange-500" height="20" width="20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M537.6 226.6c4.1-10.7 6.4-22.4 6.4-34.6 0-53-43-96-96-96-19.7 0-38.1 6-53.3 16.2C367 64.2 315.3 32 256 32c-88.4 0-160 71.6-160 160 0 2.7.1 5.4.2 8.1C40.2 219.8 0 273.2 0 336c0 79.5 64.5 144 144 144h368c70.7 0 128-57.3 128-128 0-61.9-44-113.6-102.4-125.4zm-132.9 88.7L299.3 420.7c-6.2 6.2-16.4 6.2-22.6 0L171.3 315.3c-10.1-10.1-2.9-27.3 11.3-27.3H248V176c0-8.8 7.2-16 16-16h48c8.8 0 16 7.2 16 16v112h65.4c14.2 0 21.4 17.2 11.3 27.3z">
                            </path>
                        </svg>Downloadable content</li>
                    <li class="font-medium text-gray-700"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                            viewBox="0 0 24 24" aria-hidden="true" class="mr-4 inline text-orange-500" height="20"
