            ...
            <div class="relative w-full max-w-md max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    <div class="absolute top-2 right-2">
                        <button type="submit" @click="props.hideModal"
                            class="flex justify-center items-center hover:text-orange-500 font-medium rounded-lg text-center"><i
                    ...
                    <div class="px-6 py-6 lg:px-8">
                        ...
                        <form class="space-y-6" @submit="handleSubmit">
                            ...
                            <button type="submit"
                                class="w-full text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Update</button>
                        </form>
                    </div>
                </div>
            </div>
...
const props = defineProps<{ hideModal: () => void, userDetails: any, readUserData: () => void }>()
